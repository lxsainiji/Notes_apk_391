...
class DBHelper{
  ...
  Future<bool> add(String title,String des)async{
    var db=await initDb();
  ...
  Future<List<Map<String, dynamic>>> editView(int id) async {
    var db = await initDb();
  ...
  Future<bool> updateNote(String title,String des,int id)async{
    var db=await initDb();
