            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      //Provider.of<NotesProvider>(context,listen: false).add(title: addNoteTitle.text, des: addNoteDes.text);
                      context.read<NotesProvider>().add(title: addNoteTitle.text, des: addNoteDes.text);
                      Navigator.pop(context);
                    },
                    child: Container(
                      padding: EdgeInsets.all(5),
